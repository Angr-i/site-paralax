        ...
        function sa(e) {
            ...
            b.forEach(function(t) {
                r = t.pins, i = t.markers, e.forEach(function(e) {
                    ...
                    }), e.setPositions(n + o, e.end + o), e.markerStart && i.push(P.quickSetter([
                        e.markerStart,
                        e.markerEnd
            ...
            return lb(), (1 !== o || s || l) && (qb(i = F.create({
                ...
                onUpdate: function onUpdate(e) {
                    ...
                    if (e.offset) {
                        if (i) {
                            for(r = -x.y, n = e.end; i--;){
                                if ((t = g[i]).trig.isActive || r >= t.start && r <= t.end) return void (l && (t.trig.progress += t.trig.direction < 0 ? .001 : -0.001, t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(d.y), -w, !0), S && l.progress(1)));
...
//# sourceMappingURL=index.bc3c75a0.js.map
